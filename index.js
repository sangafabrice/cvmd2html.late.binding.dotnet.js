...
if (Param.Markdown) {
  ...
  if ((new ActiveXObject('WScript.Shell')).Run(format('C:\\Windows\\System32\\cmd.exe /d /c ""{0}" 2> "{1}""', [Package.IconLink.Path, ErrorLog.Path]), WINDOW_STYLE_HIDDEN, WAIT_ON_RETURN)) {
    ErrorLog.Read();
    ErrorLog.Delete();
  }
